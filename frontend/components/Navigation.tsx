...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay - Portal-like rendering with high z-index */}
      <AnimatePresence>
        {mobileMenuOpen && (
          <>
            {/* Backdrop */}
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-80 max-w-full bg-charcoal shadow-2xl z-[101] md:hidden overflow-y-auto"
              style={{ 
                backgroundColor: 'rgb(26, 32, 44)', // Ensure solid background using charcoal color
                isolation: 'isolate'
              }}
            >
              <div className="p-6">
